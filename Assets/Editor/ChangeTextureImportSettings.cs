...
public class ChangeTextureImportSettings : ScriptableObject {
	[MenuItem ("Custom/TextureGUI")]
	static void ChangeTextureGUI() { 
		SelectedChangeGUITexture();
	}
	
	static void SelectedChangeGUITexture() { 
	...
	// ----------------------------------------------------------------------------
	[MenuItem ("Custom/Texture/Change Wrap Mode/Repeat")]
	static void ChangeTextureWrapMode_Repeat() {
		SelectedChangeWrapMode(TextureWrapMode.Repeat);
	}
	
	[MenuItem ("Custom/Texture/Change Wrap Mode/Clamp")]
	static void ChangeTextureWrapMode_Clamp() { 
		SelectedChangeWrapMode(TextureWrapMode.Clamp);
	}
	
	// ----------------------------------------------------------------------------
	[MenuItem ("Custom/Texture/Change Texture Type/Texture")]
	static void ChangeTextureType_Texture() {
		SelectedChangeTextureType(TextureImporterType.Image);
	}
	
	[MenuItem ("Custom/Texture/Change Texture Type/Normal Map")]
	static void ChangeTextureType_NormalMap() { 
		SelectedChangeTextureType(TextureImporterType.Bump);
	}
	...
	static void ChangeTextureType_Reflection() { 
		SelectedChangeTextureType(TextureImporterType.Reflection);
	}
	...
	static void ChangeTextureType_Advanced() { 
		SelectedChangeTextureType(TextureImporterType.Advanced);
	}
